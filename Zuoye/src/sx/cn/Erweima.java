...
public class Erweima {
	...
	public static void main(String[] args) throws Exception {
		...
		int version=8;
	      ...
	      BufferedImage logo=scale("D:/图片.jpg",60,60,true);
	      ...
	      gs.dispose();
	      bufferedImage.flush();
	      ImageIO.write(bufferedImage, "png", new File("D:/刘月 0911160608.png"));
	    	  System.out.println("我的二维码已生成！");
	}
		...
		File file=new File(logoPath);
		 ...
		 if (hasFiller){
		  ...
		  if(width==destImage.getHeight(null)){
			  ...
			  graphic.drawImage(destImage,(height-destImage.getWidth(null))/2,0,destImage.getWidth(null),destImage.getWidth(null),Color.WHITE,null);
